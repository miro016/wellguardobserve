...
const target: Target = { id: 'target', name: 'Example', hostname: 'example.test', hostHints: [], authorizedHosts: [], authorizationStatus: 'admin_override', status: 'observed', lastScanAt: '', assetCount: 0, findingCount: 0, posture: 100 };
