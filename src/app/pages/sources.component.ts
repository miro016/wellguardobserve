...
export class SourcesComponent {
  protected readonly sources: Source[] = [
    { name: 'Public DNS', type: 'direct observation', authority: 'DNS hierarchy', use: 'Host routing plus NS, MX, CAA, DNSSEC, SPF, DMARC, MTA-STS and TLS reporting policy.', url: 'https://www.iana.org/domains', mode: 'Read-only resolution' },
    { name: 'Authoritative RDAP', type: 'domain intelligence', authority: 'IANA bootstrap / delegated registry', use: 'Registrar, lifecycle, nameservers, network ranges, and only the contact fields registries explicitly publish.', url: 'https://data.iana.org/rdap/', mode: 'Bootstrapped public API' },
    ...
    { name: 'NIST NVD', type: 'security intelligence', authority: 'US NIST', use: 'CVE candidates and CPE applicability ranges only after an exact product version is observed.', url: 'https://nvd.nist.gov/developers/vulnerabilities', mode: 'CVE API 2.0' },
    { name: 'MITRE CWE', type: 'weakness taxonomy', authority: 'CWE Program / MITRE', use: 'Authoritative definitions for specific mappable weakness identifiers attached to configuration findings.', url: 'https://cwe.mitre.org/', mode: 'Public REST API' },
    ...
    { name: 'Application metadata', type: 'direct observation', authority: 'Authorized target response', use: 'Fixed public paths for security.txt, robots, sitemaps, OpenAPI, Swagger, GraphQL and health metadata.', url: 'https://www.rfc-editor.org/rfc/rfc9110', mode: 'Bounded anonymous GET' },
    { name: 'WordPress REST API', type: 'service inspection', authority: 'Authorized WordPress response', use: 'Public view-context users, REST routes, login, readme and XML-RPC posture without authentication.', url: 'https://developer.wordpress.org/rest-api/reference/users/', mode: 'Bounded anonymous GET' },
